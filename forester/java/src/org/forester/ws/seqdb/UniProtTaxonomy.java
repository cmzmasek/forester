...
public final class UniProtTaxonomy {
    ...
    public UniProtTaxonomy(final String line) {
        ...
        if ((lin != null) && (lin.length > 0)) {
            ...
            for (int i = 0; i < temp.size(); ++i) {
                if ((i == 0) && (temp.get(i).equalsIgnoreCase(EUKARYOTA) || temp.get(i).equalsIgnoreCase(BACTERIA) || temp.get(i).equalsIgnoreCase(ARCHAEA))) {
                    _lineage.add(CELLULAR_ORGANISMS);
                }
                _lineage.add(temp.get(i));
            }
        }
        if (_lineage.isEmpty() && (_scientific_name.equalsIgnoreCase(EUKARYOTA) || _scientific_name.equalsIgnoreCase(BACTERIA) || _scientific_name.equalsIgnoreCase(ARCHAEA))) {
            _lineage.add(CELLULAR_ORGANISMS);
        }
    ...
    public UniProtTaxonomy(final List<String> lineage, final String code, final String common_name, final String scientific_name, final String synonym, final String rank, final String id) {
        _lineage = lineage;
        _code = code;
