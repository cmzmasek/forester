...
final public class Options {
    ...
    final boolean isShowTreeName() {
        return _show_tree_name;
    }
    ...
    final boolean isShowHpdBars() {
        return _show_hpd_bars;
    }
    ...
    final void setPulseFoundNodes(final boolean pulse_found_nodes) {
        _pulse_found_nodes = pulse_found_nodes;
    }
