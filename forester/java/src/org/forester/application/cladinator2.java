...
public final class cladinator2 {

    final static private String        PRG_NAME                             = "cladinator";
    final static private String        PRG_VERSION                          = "2.0.0";
    ...
    public static void main( final String args[] ) {
        try {
            ...
            for( final Phylogeny phy : phys ) {
                ...
                if ( !quit ) {
                    if ( phys.length == 1 ) {
                        printResult2( res, -1, remove_annotation_sep );
                    }
                    else {
    ...
    private final static void printResultOLD( final ResultMulti res,
                                              final int counter,
                                              final boolean remove_annotation_sep ) {
        System.out.println();
        if ( counter == -1 ) {
