...
| [`search-emphasis.xml`](search-emphasis.xml) | **Emphasize search hits** | Search (box **a**) for `kinase` — four scattered tips match — then **Settings → Display → Bold Found Labels** and/or **Dim Non-Matches**. Hits go bold while the rest (names *and* their support / branch-length numbers) fade toward the background. Both work in exports too. |
